...
public class AppointmentCustomerDbTest {
    ...
    public void testCreateMultipleAppointmentsAndProducts(){
        ...
        assertEquals(3, aDao.findAllAppointment().size(), "Appointment size should be 3");
        assertEquals(6, cDao.findAllCustomer().size(), "Customer size should be 6");
        assertEquals(4, aDao.findByStartDateAppointment(ZonedDateTime.parse("2021-01-03T10:15:30+02:00")).findAllCustomers().size(), "Appointment size should be 4");
    }
    ...
    public void findTest(){
        ...
        for (Appointment a : appointmentList) {
            customerList.addAll(a.findAllCustomers());
        }
    ...
    public void deleteAllAppointmentsTest(){
        ...
        assertEquals(0, aDao.findAllAppointment().size(), "Appointment size should be 0");
    }
