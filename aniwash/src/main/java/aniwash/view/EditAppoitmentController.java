...
public class EditAppoitmentController extends CreatePopUp {
   ...
   public void asd() {
       ...
       System.out.println("jepiosdfljndsfjlnlsdfjn");
       ...
       System.out.println("hows it hanging");
   }
   ...
   public void sendEntry() {
        ...
        *
        * System.out.println("newEntrys id this is?!?!??!?! " +
        * newEntry.getEntry().getId());
        * entry.setId(String.valueOf(newEntry.getEntry().getId()));
        * System.out.println("tuutko tähän");
        * System.out.println("entrys id this is?!?!??!?! " +
        * newEntry.getEntry().getId());
        * entry.setUserObject(newEntry.getEntry().getId());
        *
        * products.addAppoitmEntry(entry,
       ...
       if(selectedCustomer == null){
           ...
           newEntry.getEntry().setId(String.valueOf(selectedCustomer.getId()-1));
       }
       System.out.println("tuutko tähän");
       System.out.println("entrys id this is?!?!??!?! " + newEntry.getEntry().getId());
       //newEntry.getEntry().setUserObject(selectedCustomer);
      
       products.addAppoitmEntry(newEntry.getEntry(), servicesa.get(services.getSelectionModel().getSelectedIndex() - 1));
